# Yoach 1 - ESP32 固件技术详情

**当前版本:** v0.0.2
**最后更新:** 2025-12-06
**开发平台:** ESP32 (ESP-IDF / Arduino Framework)

本项目为 **Yoach 1** 设备实现固件，使用 ESP32 平台。集成了多个子系统，包括：
- **蓝牙控制** (支持 OTA 更新)
- **灯光控制**
- **数据控制** (游戏模式设置)
...
flowchart TD
  subgraph ESP32_Project["Yoach 1 - ESP32 固件"]
    direction TB
...
本固件为 **Yoach 1** 设备打造，提供强大的控制和传感器处理能力，用于交互式应用。它充分利用 ESP32 的双核能力并发运行任务：
